...
public class JavaReconciler {
    ...
    enum Mode {
        ...
        ACTIVATED,
        /**
         * The state when the reconciler is turned off
         * for processing reconcile operation (while java refactoring in progress, for example)
         */
        DEACTIVATED
    }
}
