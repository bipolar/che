...
public class PomReconcilerTest extends BaseTest {
    ...
    public void setUp() throws Exception {
        ...
        mavenProjectManager =
                new MavenProjectManager(wrapperManager, mavenServerManager, null, terminal, mavenNotifier,
        ...
        EditorWorkingCopyManager editorWorkingCopyManager = new EditorWorkingCopyManager(projectManagerProvider, eventService, requestTransmitter);
        pomReconciler = new PomReconciler(projectManagerProvider, mavenProjectManager, editorWorkingCopyManager, eventService, requestTransmitter);
    }
