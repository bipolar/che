...
import (
	...
	"github.com/eclipse/che/agents/go-agents2/target/go-workspace/src/github.com/eclipse/che/agents/go-agents/core/process"
)
...
func (pb *Builder) SubscribeDefault(id string, channel chan *rpc.Event) *Builder {
	return pb.Subscribe(id, process.DefaultMask, channel)
}
